...
public class TelaCadastroEditais extends JPanel {
	...
	private void adcionarLabels() {
		...
		//--------------------------------------------------------
		//String nomeEdital, String novoNome, Date dataInicio, Date dataTermino, long matricula
		...
		criar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					cadastrarEdital(nomeEditalCriar.getText(), dateInicioFormatado, dateTerminoFormatado, Long.parseLong(matriculaCriar.getText()));
				} catch (Exception e1) {
					e1.printStackTrace();
				}
			}
		...
		atualizar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					atualizarEdital(antigoNomeEdital.getText(), novoNomeEdital.getText(), dateInicioFormatado, dateTerminoFormatado, Long.parseLong(matriculaAtualizar.getText()));
				} catch (Exception e1) {
					e1.printStackTrace();
				}
			}
